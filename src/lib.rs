...
#[derive(Debug)]
pub struct ReverbWaneProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ReverbWaneProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ReverbWane processing");
    
    let mut processor = ReverbWaneProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ReverbWaneProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ReverbWaneProcessor::new(false);
